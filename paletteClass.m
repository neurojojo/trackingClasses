classdef palette
    ...
    methods
        function obj = paletteobj(color)
            
            whites = [white;pearl;alabaster;snow;ivory;cream;eggshell;cotton;chiffon;salt;lace;coconut;linen;bone;daisy;powder;frost;porcelain;parchment;rice];
            tans = [tan;beige;macaroon;hazelwood;granola;fawn;oat;eggnog;fawn;sugarcookie;sand;sepia;latte;oyster;biscotti;parmesean;hazelnut;sandcastle;buttermilk;sanddollar;shortbread];
            yellows = [yellow;canary;gold;daffodil;flaxen;butter;lemon;mustard;corn;medallion;dandelion;yellowfire;bumblebee;banana;butterscotch;dijon;honey;blonde;pineapple;tuscansun];
            oranges = [orange;tangerine;merigold;cider;rust;ginger;tiger;redfire;bronze;cantaloupe;apricot;clay;honey;carrot;squash;spice;marmalade;amber;sandstone;yam];
            reds = [red;cherry;rosered;jam;merlot;garnet;crimson;ruby;scarlet;winered;brick;apple;mahogany;blood;sangriared;berryred;currant;blushred;candy;lipstick];
            pinks = [pink;rosepink;fuscia;punch;blushpink;watermelon;flamingo;rogue;salmon;coral;peach;strawberry;rosewood;lemonade;taffy;bubblegum;balletslipper;crepe;magentapink;hotpink];
            purples = [purple;mauve;violet;boysenberry;lavender;plum;magentapurple;lilac;grape;periwinkle;sangriapurple;eggplant;jam;iris;heather;amethlyst;rasin;orchid;mulberry;winepurple];
            blues = [blue;slate;sky;navy;indigo;cobalt;teal;ocean;peacock;azure;cerulean;lapis;spruce;stone;aegean;blueberry;denim;admiral;sapphire;artic];
            greens = [green;chartreuse;juniper;sage;lime;fern;olive;emerald;pear;moss;shamrock;seafoam;pine;parakeet;mint;seaweed;pickle;pistachio;basil;crocodile];
            browns = [brown;coffee;mocha;peanut;carob;hickory;wood;pecan;walnut;caramel;gingerbread;syrup;chocolate;tortilla;umber;tawny;brunette;cinnamon;penny;cedar];
            grays = [grey;shadow;graphite;iron;pewter;cloud;silver;smoke;slate;anchor;ash;porpoise;dove;fog;flint;charcoal;pebble;lead;coin;fossil];
            blacks = [black;ebony;crow;charcoal;midnight;ink;raven;oil;grease;onyx;pitch;soot;sable;jetblack;coal;metal;obsidian;jade;spider;leather];
